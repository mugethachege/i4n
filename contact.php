<link href="assets/src/facebox.css" media="screen" rel="stylesheet" type="text/css" />
   <script src="assets/lib/jquery.js" type="text/javascript"></script>
  <script src="assest/src/facebox.js" type="text/javascript"></script>
  <script type="text/javascript">
    jQuery(document).ready(function($) {
      $('a[rel*=facebox]').facebox({
        loadingImage : 'assets/src/loading.gif',
        closeImage   : 'assets/src/closelabel.png'
      })
    })
  </script>
<style>
...
$date=$_POST['date'];
$qty=$_POST['qty'];
$result = mysql_query("SELECT * FROM resource_info WHERE resource_id='$busnum'");
while($row = mysql_fetch_array($result))
	{
		$numofrooms=$row['numrooms'];
